var ViewModelVisitasDetalle = function () {
    ...
    var visitasUri = 'http://'.concat(host, '/api/DetalleVisitas');
    ...
    function getAllVisitas() {
        ...
        ajaxHelper(visitasUri + '?CodigoVisita=' + id[1],'GET').done(function (data) {
            ...
            //alert(JSON.stringify(ko.toJS(self.visitasDetalle()[0].Latitud)));
            var item = self.visitasDetalle()[0];
            self.Latitud(self.visitasDetalle()[0].Latitud);
            self.Longitud(self.visitasDetalle()[0].Longitud);
            ...
            var marker = new google.maps.Marker({
                ...
                map: map,
                title: self.visitasDetalle()[0].Descripcion
            });
            ...
            function createInfoWindowContent(latLng, zoom) {
                ...
                return [
                  '<b>Proyecto:</b> ' + item.Descripcion,
                  '<b>Descripción:</b> ' + '<br>' + item.Valla,
                  '<b>Problema: </b>' + item.ProblemaPublicidad,
